...
OUTPUT_DIR = Path("." if ON_KAGGLE else "../data/submission")
PATH_TO_GRAPH_DIR=Path("." if ON_KAGGLE else "../data/graph")
PATH_TO_MODEL_DIR=Path("." if ON_KAGGLE else "../data/model")
PATH_TO_UPLOAD_MODEL_PARENT_DIR=Path("../input" if ON_KAGGLE else "../data/model")
PATH_TO_FEATURES_DIR=Path("." if ON_KAGGLE else "../data/features")
